...
def confirm_action(template=None, title="Are you sure?", short_description=None):
    ...
    template:
        ...
        If choosing one custom, see admin/custom_action_confirmation.html for existing blocks or redefine entirely.
    title:
        The <title> to be used in the page
    short_description:
        Used by the default template as in "Are you sure you want to <SHORT_DESCRIPTION> for the following..."
